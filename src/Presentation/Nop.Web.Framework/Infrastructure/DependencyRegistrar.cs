...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CustomerWarehouseService>().As<ICustomerWarehouseService>().InstancePerLifetimeScope();            
            ...
            builder.RegisterType<InventoryPurchaseService>().As<IInventoryPurchaseService>().InstancePerLifetimeScope();
            builder.RegisterType<Services.Notifications.NotificationService>().As<Services.Notifications.INotificationService>().InstancePerLifetimeScope();
